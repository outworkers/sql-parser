...
object Publishing {
  ...
  lazy val bintraySettings: Seq[Def.Setting[_]] = Seq(
    ...
    licenses += ("Apache-2.0", url("https://github.com/outworkers/sql-parser/blob/develop/LICENSE.txt"))
  )
  ...
  lazy val mavenSettings: Seq[Def.Setting[_]] = Seq(
    ...
    licenses += ("Outworkers License", url("https://github.com/outworkers/sql-parser/blob/develop/LICENSE.txt")),
    publishArtifact in Test := false,
    pomIncludeRepository := { _ => true },
    pomExtra :=
      <url>https://github.com/outworkers/sql-parser</url>
        <scm>
          <url>git@github.com:outworkers/sql-parser.git</url>
          <connection>scm:git:git@github.com:outworkers/sql-parser.git</connection>
        </scm>
        <developers>
          <developer>
            <id>alexflav</id>
